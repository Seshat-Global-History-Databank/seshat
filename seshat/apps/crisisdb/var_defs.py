crisisdb_var_defs = {
    'instability_event': 'a significant historical event characterized by social, political, or economic turmoil. This model captures key attributes of such events, including their types, intensity, extent, and reliability.',
