...
from ..forms import (
    PopulationForm,
    Land_taxes_collectedForm,
    Land_yieldForm,
    Total_taxForm,
    Total_economic_outputForm,
    Total_revenueForm,
    Diding_taxesForm,
    Salt_taxForm,
    Tariff_and_transitForm,
    Misc_incomesForm,
    Total_expenditureForm,
    BalanceForm,
    LijinForm,
    Maritime_customForm,
    Other_incomesForm,
    Revenue_officialForm,
    Revenue_realForm,
)
    ...
    for obj in items:
        writer.writerow(
            [
                ...
                obj.year_to,
                obj.polity,
                obj.total_amount_of_taxes_collected,
            ]
        )
...
def total_economic_output_download(request):
    ...
    response["Content-Disposition"] = (
        'attachment; filename="total_economic_outputs.csv"'
    )
...
vars_dic = {
    ...
    "Salt_tax": {"model": Salt_tax, "list": Salt_taxListView, "create": Salt_taxCreate},
    "Tariff_and_transit": {
        "model": Tariff_and_transit,
    ...
    "Balance": {"model": Balance, "list": BalanceListView, "create": BalanceCreate},
    "Lijin": {"model": Lijin, "list": LijinListView, "create": LijinCreate},
    "Maritime_custom": {
        "model": Maritime_custom,
