        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Enter a book Genre Please...", max_length=200
                    ),
                ),
                (
                    "year",
                ...
                (
                    "creator",
                    models.CharField(help_text="Creator of pub", max_length=100),
                ),
                (
                    "zotero_link",
                    models.CharField(
                        help_text="choose the 8-digit Zotero link", max_length=100
                    ),
                ),
            ],
        ),
