...
class ShapesTest(TestCase):
    ...
    def test_assign_categorical_variables_to_shapes(self):
        ...
        self.assertEqual(result_shapes[0]['religious_level_from'], 9)
        self.assertEqual(result_shapes[0]['religious_level_to'], 10)
        self.assertEqual(result_shapes[0]['military_level_from'], 13)
        self.assertEqual(result_shapes[0]['military_level_to'], 14)
        self.assertEqual(result_shapes[0]['administrative_level_from'], 5)
        self.assertEqual(result_shapes[0]['administrative_level_to'], 6)