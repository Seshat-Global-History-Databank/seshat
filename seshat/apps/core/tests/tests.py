...
class ShapesTest(TestCase):
    ...
    def setUp(self):
        ...
        self.gadm_shapefile = GADMShapefile.objects.create(
            geom=self.square, UID=123456789, NAME_0="Test shape"
        )
        ...
        self.country = GADMCountries.objects.create(
            geom=self.square, COUNTRY="Test Country"
        )
        self.capital = Capital.objects.create(
            name="Test Capital", latitude=51.567522, longitude=-0.1294531
        )
        Capital.objects.create(
            name="Test Capital 2", latitude=51.567523, longitude=-0.1294532
        )
        Capital.objects.create(
            name="Test Capital 2A", latitude=51.567523, longitude=-0.1294532
        )
        ...
        Polity_capital.objects.create(
            name="TestPolity2", capital="Test Capital 2", polity_id=2
        )
        Polity_capital.objects.create(
            name="TestPolity2",
    ...
    def test_polity_map_no_content(self):
        ...
        expected_result = {"content": {"include_polity_map": False}}
    ...
    def test_assign_variables_to_shapes(self):
        ...
        self.assertEqual(
            result_variables["Religion Tolerance"]["gov_res_pub_pros"],
            expected_result_variables_gov_res_pub_pros,
        )
    ...
    def test_assign_categorical_variables_to_shapes(self):
        ...
        self.assertEqual(
            result_variables["General Variables"]["polity_language"],
            expected_result_variables_language,
        )
