...
"professional_lawyer": "Talking about Law, we have coded the absence or presence of the variable..",
"irrigation_system": "Talking about Specialized Buildings, irrigation systems are polity owned (which includes owned by the community, or the state), we have coded the absence or presence of the variable.",
"drinking_water_supply_system": "Talking about Specialized Buildings, drinking water supply systems are polity owned (which includes owned by the community, or the state), we have coded the absence or presence of the variable.",
"market": "Talking about Specialized Buildings, markets are polity owned (which includes owned by the community, or the state), we have coded the absence or presence of the variable.",
"food_storage_site": "Talking about Specialized Buildings, food storage sites are polity owned (which  includes owned by the community, or the state), we have coded the absence or presence of the variable.",
...
"mines_or_quarry": "Talking about Special purpose sites, we have coded the absence or presence of the variable.",
...
"lists_tables_and_classification": "Talking about Kinds of Written Documents, we have coded the absence or presence of the variable.",
"calendar": "Talking about Kinds of Written Documents, we have coded the absence or presence of the variable.",
...
"history": "Talking about Kinds of Written Documents, we have coded the absence or presence of the variable.",
"philosophy": "Talking about Kinds of Written Documents, we have coded the absence or presence of the variable.",
