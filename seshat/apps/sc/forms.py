...
class Largest_communication_distanceForm(forms.ModelForm):
    class Meta:
        ...
        labels = commonlabels
        labels['largest_communication_distance_from'] = mark_safe("Largest Communication <br> Distance (From):")
        labels['largest_communication_distance_to'] = mark_safe("Largest Communication <br> Distance (To):")
        widgets = dict(commonwidgets)
...
class Fastest_individual_communicationForm(forms.ModelForm):
    class Meta:
        ...
        labels['fastest_individual_communication_from'] = mark_safe("Fastest Individual <br> Communication (From):")
        labels['fastest_individual_communication_to'] = mark_safe("Fastest Individual <br> Communication (To):")
        widgets = dict(commonwidgets)
