...
model_form_pairs = [
(Polity_territory, Polity_territoryForm, 'polity_territory', 'Polity Territory', 'Social Complexity', 'Social Scale'),
(Polity_population, Polity_populationForm, 'polity_population', 'Polity Population', 'Social Complexity', 'Social Scale'),
(Population_of_the_largest_settlement, Population_of_the_largest_settlementForm, 'population_of_the_largest_settlement', 'Population Of The Largest Settlement', 'Social Complexity', 'Social Scale'),
(Settlement_hierarchy, Settlement_hierarchyForm, 'settlement_hierarchy', 'Settlement Hierarchy', 'Social Complexity', 'Hierarchical Complexity'),
(Administrative_level, Administrative_levelForm, 'administrative_level', 'Administrative Level', 'Social Complexity', 'Hierarchical Complexity'),
(Religious_level, Religious_levelForm, 'religious_level', 'Religious Level', 'Social Complexity', 'Hierarchical Complexity'),
(Military_level, Military_levelForm, 'military_level', 'Military Level', 'Social Complexity', 'Hierarchical Complexity'),
(Professional_military_officer, Professional_military_officerForm, 'professional_military_officer', 'Professional Military Officer', 'Social Complexity', 'Professions'),
(Professional_soldier, Professional_soldierForm, 'professional_soldier', 'Professional Soldier', 'Social Complexity', 'Professions'),
(Professional_priesthood, Professional_priesthoodForm, 'professional_priesthood', 'Professional Priesthood', 'Social Complexity', 'Professions'),
(Full_time_bureaucrat, Full_time_bureaucratForm, 'full_time_bureaucrat', 'Full Time Bureaucrat', 'Social Complexity', 'Bureaucracy characteristics'),
(Examination_system, Examination_systemForm, 'examination_system', 'Examination System', 'Social Complexity', 'Bureaucracy characteristics'),
(Merit_promotion, Merit_promotionForm, 'merit_promotion', 'Merit Promotion', 'Social Complexity', 'Bureaucracy characteristics'),
(Specialized_government_building, Specialized_government_buildingForm, 'specialized_government_building', 'Specialized Government Building', 'Social Complexity', 'Bureaucracy characteristics'),
(Formal_legal_code, Formal_legal_codeForm, 'formal_legal_code', 'Formal Legal Code', 'Social Complexity', 'Law'),
(Judge, JudgeForm, 'judge', 'Judge', 'Social Complexity', 'Law'),
(Court, CourtForm, 'court', 'Court', 'Social Complexity', 'Law'),
(Professional_lawyer, Professional_lawyerForm, 'professional_lawyer', 'Professional Lawyer', 'Social Complexity', 'Law'),
(Irrigation_system, Irrigation_systemForm, 'irrigation_system', 'Irrigation System', 'Social Complexity', 'Specialized Buildings'),
(Drinking_water_supply_system, Drinking_water_supply_systemForm, 'drinking_water_supply_system', 'Drinking Water Supply System', 'Social Complexity', 'Specialized Buildings'),
(Market, MarketForm, 'market', 'Market', 'Social Complexity', 'Specialized Buildings'),
(Food_storage_site, Food_storage_siteForm, 'food_storage_site', 'Food Storage Site', 'Social Complexity', 'Specialized Buildings'),
(Road, RoadForm, 'road', 'Road', 'Social Complexity', 'Transport infrastructure'),
(Bridge, BridgeForm, 'bridge', 'Bridge', 'Social Complexity', 'Transport infrastructure'),
(Canal, CanalForm, 'canal', 'Canal', 'Social Complexity', 'Transport infrastructure'),
(Port, PortForm, 'port', 'Port', 'Social Complexity', 'Transport infrastructure'),
(Mines_or_quarry, Mines_or_quarryForm, 'mines_or_quarry', 'Mines Or Quarry', 'Social Complexity', 'Special purpose sites'),
(Mnemonic_device, Mnemonic_deviceForm, 'mnemonic_device', 'Mnemonic Device', 'Social Complexity', 'Writing Systems'),
(Nonwritten_record, Nonwritten_recordForm, 'nonwritten_record', 'Nonwritten Record', 'Social Complexity', 'Writing Systems'),
(Written_record, Written_recordForm, 'written_record', 'Written Record', 'Social Complexity', 'Writing Systems'),
(Script, ScriptForm, 'script', 'Script', 'Social Complexity', 'Writing Systems'),
(Non_phonetic_writing, Non_phonetic_writingForm, 'non_phonetic_writing', 'Non Phonetic Writing', 'Social Complexity', 'Writing Systems'),
(Phonetic_alphabetic_writing, Phonetic_alphabetic_writingForm, 'phonetic_alphabetic_writing', 'Phonetic Alphabetic Writing', 'Social Complexity', 'Writing Systems'),
(Lists_tables_and_classification, Lists_tables_and_classificationForm, 'lists_tables_and_classification', 'Lists Tables And Classification', 'Social Complexity', 'Kinds of Written Documents'),
(Calendar, CalendarForm, 'calendar', 'Calendar', 'Social Complexity', 'Kinds of Written Documents'),
(Sacred_text, Sacred_textForm, 'sacred_text', 'Sacred Text', 'Social Complexity', 'Kinds of Written Documents'),
(Religious_literature, Religious_literatureForm, 'religious_literature', 'Religious Literature', 'Social Complexity', 'Kinds of Written Documents'),
(Practical_literature, Practical_literatureForm, 'practical_literature', 'Practical Literature', 'Social Complexity', 'Kinds of Written Documents'),
(History, HistoryForm, 'history', 'History', 'Social Complexity', 'Kinds of Written Documents'),
(Philosophy, PhilosophyForm, 'philosophy', 'Philosophy', 'Social Complexity', 'Kinds of Written Documents'),
(Scientific_literature, Scientific_literatureForm, 'scientific_literature', 'Scientific Literature', 'Social Complexity', 'Kinds of Written Documents'),
(Fiction, FictionForm, 'fiction', 'Fiction', 'Social Complexity', 'Kinds of Written Documents'),
(Article, ArticleForm, 'article', 'Article', 'Social Complexity', 'Forms of money'),
(Token, TokenForm, 'token', 'Token', 'Social Complexity', 'Forms of money'),
(Precious_metal, Precious_metalForm, 'precious_metal', 'Precious Metal', 'Social Complexity', 'Forms of money'),
(Foreign_coin, Foreign_coinForm, 'foreign_coin', 'Foreign Coin', 'Social Complexity', 'Forms of money'),
(Indigenous_coin, Indigenous_coinForm, 'indigenous_coin', 'Indigenous Coin', 'Social Complexity', 'Forms of money'),
(Paper_currency, Paper_currencyForm, 'paper_currency', 'Paper Currency', 'Social Complexity', 'Forms of money'),
(Courier, CourierForm, 'courier', 'Courier', 'Social Complexity', 'Postal sytems'),
(Postal_station, Postal_stationForm, 'postal_station', 'Postal Station', 'Social Complexity', 'Postal sytems'),
(General_postal_service, General_postal_serviceForm, 'general_postal_service', 'General Postal Service', 'Social Complexity', 'Postal sytems'),
