...
rt_var_defs = {
    "Official religion": "This variable is coded to capture the official religion within the polity. It reflects the specific religious faith officially endorsed and supported by the polity as the polity religion, if any.",
    "Elites religion": "Coded to capture the religion associated with or favored by the political or societal elites within the polity, this variable reflects the specific religious belief system prevalent among the elite class, if identifiable.",
    "Widespread religion": "This variable captures the prevalence of widespread religions within the polity. It includes the most widespread religion, the second most "
    ...
    "Theological syncretism of different religions": "This variable is coded to indicate the presence or absence of theological syncretism among different religions within the polity. "
    "It reflects whether diverse religious beliefs coexist and influence each other's theological doctrines.",
    "Syncretism of religious practices at the level of individual believers": "Coded to reflect the presence or absence of syncretism of religious practices at the individual level, "
    ...
    "Religious fragmentation": "Coded to assess the level of diversity and division among religious groups within the polity, "
    ...
    "Frequency of governmental violence against religious groups": "This variable is coded to indicate the presence or absence of governmental violence against religious groups within the polity. "
    "It provides insights into the relationship between the state and religious communities, particularly in terms of conflict.",
    "Government restrictions on public worship": "Coded to reflect the presence or absence of government control over public worship, "
    "this variable indicates whether authorities regulate and limit religious gatherings and ceremonies within the polity.",
    "Government restrictions on public proselytizing": "Coded to indicate the presence or absence of government restrictions on public proselytizing, "
    ...
    "Government restrictions on conversion": "Coded to reflect the presence or absence of government constraints on religious conversion, "
    ...
    "Government pressure to convert": "Coded to indicate the presence or absence of government-induced pressure for religious conversion, "
    ...
    "Government restrictions on property ownership for adherents of any religious group": "Coded to indicate the presence or absence of government restrictions on property ownership for religious adherents, "
    ...
    "Taxes based on religious adherence or on religious activities and institutions": "This variable is coded to indicate the presence or absence of taxes based on religious adherence or on religious activities and institutions. "
    "It reflects the financial burdens placed on religious individuals and institutions within the polity.",
    "Governmental obligations for religious groups to apply for official recognition": "Coded to indicate the presence or absence of governmental obligations for religious groups to seek official recognition, "
    ...
    "Government restrictions on construction of religious buildings": "Coded to indicate the presence or absence of government limitations on the construction of religious buildings, "
    "this variable reflects the extent to which authorities regulate the establishment of places of worship within the polity.",
    "Government restrictions on religious education": "Coded to indicate the presence or absence of government restrictions on religious education, "
    ...
    "Government restrictions on circulation of religious literature": "Coded to indicate the presence or absence of government restrictions on the circulation of religious literature, "
    "this variable reflects limitations on the production, distribution, and accessibility of religious texts within the polity.",
    "Government discrimination against religious groups taking up certain occupations or functions": "Coded to indicate the presence or absence of government discrimination against religious groups in terms of access to specific occupations or functions, "
    ...
    "Frequency of societal violence against religious groups": "This variable is coded to indicate the presence or absence of societal violence against religious groups within the polity. "
    "It reflects the extent to which non-governmental entities engage in violent actions against religious communities.",
    "Societal discrimination against religious groups taking up certain occupations or functions": "Coded to indicate the presence or absence of societal discrimination against religious groups in occupational or functional contexts, "
    ...
    "Societal pressure to convert or against conversion": "Coded to indicate the presence or absence of societal pressure for religious conversion or against conversion, "
    ...
    "Frequency of governmental violence against religious groups": "This variable is coded to measure the frequency of governmental violence against religious groups within the polity. "
    ...
    "Frequency of societal violence against religious groups": "This variable is coded to measure the frequency of societal violence against religious groups within the polity. "
