...
class Polity_suprapolity_relations(SeshatCommon):
    ...
    def display_value(self):
        if self.supra_polity_relations and self.other_polity and self.polity:
            ...
            return f"<a  data-bs-toggle='tooltip' data-bs-html='true'  title='{self.polity.long_name}' href='{polity_url}'>{self.polity.new_name}</a> <span class='badge bg-success text-dark'> {self.get_supra_polity_relations_display()} </span> <a  data-bs-toggle='tooltip' data-bs-html='true'  title='{self.other_polity.long_name}' href='{other_polity_url}'>{self.other_polity.new_name}</a>"
