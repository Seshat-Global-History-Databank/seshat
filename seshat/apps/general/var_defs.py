...
'vassalage' = corresponding to 'loose' category in the Degree of centralization""",
    ...
    'polity_city': 'Any city within within the polity boundaries that is not the capital. If there were multiple cities supply all names and enclose in curly braces. For example, {Susa; Pasargadae; Persepolis; Ecbatana; Babylon}.',
